...
//==================BLOCKCHAIN======================//
const getAllBlockchainLog = (data) => {
    return axios.get(`/api/get-all-blockchainlog?limit=${data.limit}&offset=${data.offset}&keyword=${data.keyword}`);
}
const getAllBlockchainLogLC = (contract) => {
    return axios.get(`/api/get-all-blockchainlogLC?limit=${contract.limit}&offset=${contract.offset}&keyword=${contract.keyword}`);
}

export {
    getAllBlockchainLog, getAllBlockchainLogLC,
