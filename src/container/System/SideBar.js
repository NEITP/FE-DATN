...
const SideBar = () => {
    // State để lưu trữ thông tin người dùng từ localStorage
    const [user, setUser] = useState({})

    // useEffect để load dữ liệu người dùng khi component được render
    useEffect(() => {
        // Lấy dữ liệu người dùng từ localStorage và set vào state
        const userData = JSON.parse(localStorage.getItem('userData'));
        setUser(userData)
    }, [])  // Mảng phụ thuộc rỗng giúp chỉ chạy 1 lần khi component mount
            ...
            <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div className="sb-sidenav-menu">
                    <div className="nav">
                        ...
                        {/* Tiêu đề cho các mục Quản lý */}
                        <div className="sb-sidenav-menu-heading">Quản lý</div>

                        {/* Kiểm tra quyền người dùng, nếu người dùng có roleId là "R1", sẽ hiển thị các mục quản lý */}
                        {user && user.roleId === "R1" &&
                            <>
                                {/* Quản lý người dùng */}
                        ...
                        <a className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseSupplier" aria-expanded="false" aria-controls="collapseLayouts">
                            {/* Icon hiển thị bên cạnh "Quản lý NCC" */}
                            <div className="sb-nav-link-icon"><i class="fa-solid fa-person-military-pointing"></i></div>
                            Quản lý NCC
                            {/* Icon mũi tên để mở/đóng menu */}
                            <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down" /></div>
                        </a>

                        {/* Menu con của Quản lý NCC */}
                        ...
                        <a className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseReceipt" aria-expanded="false" aria-controls="collapseLayouts">
                            {/* Icon hiển thị bên cạnh "Quản lý nhập hàng" */}
                        ...
                        {/* Menu con của Quản lý nhập hàng */}
                        ...
                        <a className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseOrder" aria-expanded="false" aria-controls="collapseLayouts">
                            {/* Icon hiển thị bên cạnh "Quản lý đơn hàng" */}
                        ...
                        <a className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseMessage" aria-expanded="false" aria-controls="collapseLayouts">
                            {/* Icon hiển thị bên cạnh "Quản lý tin nhắn" */}
                        ...
                        {/* Hiển thị phần thống kê khi người dùng có quyền R1 */}
                        {user && user.roleId === "R1" &&
                            <>
                                {/* Mục Thống kê */}
                                <a className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseStatistic" aria-expanded="false" aria-controls="collapseStatistic">
                                    <div className="sb-nav-link-icon"><i className="fa-solid fa-magnifying-glass-chart"></i></div>
                                    Thống kê
                                    <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down" /></div>
                                </a>

                                {/* Menu con của Thống kê */}
                                ...
                                {/* Mục Blockchain */}
                                <a className="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseBlockchain" aria-expanded="false" aria-controls="collapseBlockchain">
                                    <div className="sb-nav-link-icon"><i className="fa-solid fa-magnifying-glass-chart"></i></div>
                                    BlockChain
                                    <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down" /></div>
                                </a>

                                {/* Menu con của Blockchain */}
                                <div className="collapse" id="collapseBlockchain" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
